...
namespace SunEngine
{
	...
	bool DirectXTexture::Create(const ITextureCreateInfo & info)
	{
	...
	void DirectXTexture::Bind(ICommandBuffer *)
	{
	}

	void DirectXTexture::Unbind(ICommandBuffer *)
	{
	}

	void DirectXTexture::BindToShader(DirectXShader * pShader, uint binding)
	{
		pShader->BindTexture(this, binding);
	}

	bool DirectXTexture::Destroy()
	{
