...
namespace SunEngine
{
	...
	bool DirectXSurface::Create(GraphicsWindow * window)
	{
		_window = window;
	...
	bool DirectXSurface::StartFrame(ICommandBuffer * cmdBuffer)
	{
		return true;
	}

	bool DirectXSurface::SubmitFrame(ICommandBuffer * cmdBuffer)
	{
		_swapchain->Present(1, 0);
		return true;
	}

	void DirectXSurface::Bind(ICommandBuffer * cmdBuffer)
	{
	...
	void DirectXSurface::Unbind(ICommandBuffer * cmdBuffer)
	{
		DirectXCommandBuffer* dxCmd = (DirectXCommandBuffer*)cmdBuffer;
	...
	bool DirectXSurface::createSwapchain()
	{
	...
	bool DirectXSurface::createRenderTargetViews()
	{
	...
	bool DirectXSurface::createDepthStencilView()
	{
