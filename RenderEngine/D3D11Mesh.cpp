...
namespace SunEngine
{
	...
	bool D3D11Mesh::Create(const IMeshCreateInfo & info)
	{
	...
	void D3D11Mesh::Bind(ICommandBuffer * cmdBuffer, IBindState*)
	{
	...
	void D3D11Mesh::Unbind(ICommandBuffer * cmdBuffer)
	{
		D3D11CommandBuffer* dxCmd = (D3D11CommandBuffer*)cmdBuffer;
	...
	bool D3D11Mesh::CreateDynamicVertexBuffer(uint stride, uint size, const void* pVerts)
	{
		COM_RELEASE(_vertexBuffer);
	...
	bool D3D11Mesh::UpdateVertices(uint offset, uint size, const void* pVerts)
	{
	...
	bool D3D11Mesh::CreateDynamicIndexBuffer(uint numIndices, const uint* pIndices)
	{
		COM_RELEASE(_indexBuffer);
	...
	bool D3D11Mesh::UpdateIndices(uint offset, uint numIndices, const uint* pIndices)
	{
